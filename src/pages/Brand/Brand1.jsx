...
const Brand1 = () => {
    ...
    return (
        <div className={styles.container}>
            ...
            <meta
                name="description"
                content="현대건설 힐스테이트 브랜드 철학과 가치를 담은 힐스테이트 도안리버파크. 품질 기준, 첨단 시공 기술, 프리미엄 주거문화로 입주민의 생활 품격을 높입니다."
            />
            ...
            <meta property="og:title" content="힐스테이트 도안리버파크 - 브랜드 소개" />
            <meta
                property="og:description"
                content="현대건설 힐스테이트 브랜드 소개: 철학과 가치, 프리미엄 품질 기준과 시공 신뢰성으로 완성되는 도안신도시 힐스테이트 도안리버파크."
            />
            ...
            <h1 className={styles.screenReaderOnly}>힐스테이트 도안리버파크 - 브랜드소개</h1>
			<p className={styles.screenReaderOnly}>힐스테이트 도안리버파크의 신뢰와 품질을 최우선으로 여기는 브랜드입니다. 최첨단 설계와 고급 자재를 사용하여 입주자에게 최고의 주거 환경을 제공합니다. 지속적인 혁신과 고객 만족을 위한 브랜드 철학을 바탕으로, 미래 지향적인 주택을 제시하는 브랜드 가치를 경험해보세요</p>	

            <div className={`${styles.textBox} ${isTextVisible ? styles.active : ''}`}>
                <div>생활의 모든 것을 한걸음에</div>
                <div>힐스테이트, 도안의 중심에 서다</div>
</div>

            <img className={`${styles.image} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="힐스테이트 도안리버파크 brand-Image1" />

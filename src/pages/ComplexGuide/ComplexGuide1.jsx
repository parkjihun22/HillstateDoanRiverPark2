...
const ComplexGuide1 = () => {
	...
	return (
		<div className={styles.container}>
				...
				<meta
					name="description"
					content="대전 도안신도시 힐스테이트 도안리버파크 단지배치도를 통해 각 동의 위치, 조경, 커뮤니티 시설 및 주차·동선 설계를 확인하세요. 입주민 생활 편의와 쾌적한 환경을 고려한 최적의 배치를 안내합니다."
				/>
				...
				<meta property="og:title" content="힐스테이트 도안리버파크 - 단지배치도" />
				<meta
					property="og:description"
					content="힐스테이트 도안리버파크 단지배치도: 각 동의 위치, 조경과 커뮤니티, 주차·동선까지 생활 편의를 고려한 최적 설계."
				/>
				...
				<meta name="twitter:title" content="힐스테이트 도안리버파크 - 단지배치도" />
				<meta
					name="twitter:description"
					content="대전 도안신도시 힐스테이트 도안리버파크 단지배치도: 조경·커뮤니티·주차·동선까지 입주민 생활 편의를 고려한 설계를 확인하세요."
				/>
				...
				<script type="application/ld+json">
					...
					"description":
						"대전 도안신도시 힐스테이트 도안리버파크 단지배치도: 각 동의 위치, 조경, 커뮤니티 시설, 주차·동선 설계를 확인하세요.",
					"primaryImageOfPage": {
						"@type": "ImageObject",
            ...
            <h1 className={styles.screenReaderOnly}>힐스테이트 도안리버파크 - 단지배치도</h1>
			<p className={styles.screenReaderOnly}>단지 배치도 페이지는 힐스테이트 도안리버파크의 전체 단지 구성도를 제공합니다. 아파트 단지 내 세대 배치, 공용 시설, 주차 공간 등을 시각적으로 보여주어 입주자들이 공간 배치에 대해 명확하게 이해할 수 있도록 돕습니다. 이 배치도를 통해 단지 내 생활을 더 쉽게 계획할 수 있습니다.
			</p>

...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `충청권 최대 5,000세대 브랜드 대단지`,
    text2: `1·2·3·5단지 총 5,329세대 규모<br/>
            대전 서남부 신흥 주거벨트의 중심`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `광역 교통망 호재`,
    text2: `대전 도시철도 2호선(트램, 예정) 개통<br/>
            유성IC·현충원IC(예정)로 <br/>전국 어디든 빠른 연결`,
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `의료·생활 인프라 풍부`,
    text2: `충남대학교병원·유성선병원 등 <br/>대형 의료기관 인접<br/>
            홈플러스·대형마트·카페거리 원스톱 생활`,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `쾌적한 자연·친환경 환경`,
    text2: `갑천·유림공원·도안근린공원 등 풍부한 녹지<br/>
            서남부종합스포츠타운(예정)`,
    ...
    <>
      ...
      {!isMobile ? (
        ...
        <>
          ...
          <div className={styles.imageContainer}>
            ...
            <div className={styles.mainImageTextBox}>
              ...
              <div className={styles.mainImageTitleBox}>
                <div className={styles.mainImageText}>도안이 기다린 미래 프리미엄</div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - 대전 도시철도 2호선(트램, 예정) 인접, 유성IC·현충원IC(예정)로 우수한 광역 교통망<br />
                  - 충남대학교병원·유성선병원 등 대형 의료기관 인접, 안심 의료 인프라<br />
                  - 갑천·유림공원·도안근린공원 등 풍부한 녹지와 쾌적한 자연환경<br />
                  - 홈플러스·대형마트·카페거리 등 생활·문화 인프라 밀집
                </div>
          ...
          <div className={styles.section}>
            <div className={styles.section8}>
              ...
              <img
                src={section8Img3}
                alt="힐스테이트 도안리버파크 입지환경소개-image2"
                loading="lazy"
                decoding="async"
              />
            </div>
          ...
          <div className={styles.section}>
            <div className={styles.section2}>
              ...
              <img
                src={section2_Image1}
                alt="힐스테이트 도안리버파크 아파트 조감도-image3"
                loading="lazy"
                decoding="async"
              />
            </div>
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.text3}>
            - 대전 도시철도 2호선(트램, 예정)유성IC·현충원IC(예정)로 광역 교통망<br />
            - 충남대학교병원·유성선병원 등 대형 의료기관 인접<br />
            - 갑천·유림공원·도안근린공원 등 녹지와 공원 인접, 쾌적한 자연환경<br />
            - 홈플러스·대형마트·카페거리 등 풍부한 생활·문화 인프라 밀집
          </div>
            <div className={styles.text4}>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 힐스테이트 도안리버파크에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="힐스테이트 도안리버파크 모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="힐스테이트 도안리버파크 오시는길안내-mobileimage2"
              />
            </div>
          </div> */}

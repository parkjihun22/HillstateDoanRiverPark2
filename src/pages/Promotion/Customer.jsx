  ...
  return (
    ...
    <>
      <Helmet>
        ...
        <title>힐스테이트 도안리버파크 - 관심고객등록</title>
        <meta
          name="description"
          content="대전 도안신도시 힐스테이트 도안리버파크 관심고객 등록 시 모델하우스 방문예약, 위치 및 현장정보를 사전에 안내받으실 수 있습니다."
        />
        ...
        <meta property="og:title" content="힐스테이트 도안리버파크 - 관심고객등록" />
        <meta
        ...
        <meta name="twitter:title" content="힐스테이트 도안리버파크 - 관심고객등록" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "WebPage",
            "name": "힐스테이트 도안리버파크 - 관심고객등록",
            "url": "https://www.apay.co.kr/Promotion/Customer",
            "description":
              "대전 도안신도시 힐스테이트 도안리버파크 관심고객 등록 시 모델하우스 방문예약, 위치 및 현장정보를 사전에 안내받으실 수 있습니다.",
            "primaryImageOfPage": {
              "@type": "ImageObject",
      ...
      <div className={styles.customerWrap}>
        ...
        <div className={styles.customerLeft}>
          <div className={styles.textBlock}>
            <h2 className={styles.projectName}>힐스테이트 도안리버파크</h2>
